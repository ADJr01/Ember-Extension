...
return void 0===t||t}(n)):(r=null,i=!1),this.__inverseKey=r,this.__inverseIsAsync=i}}var Y,K,Q
function J(e,t,r,i,n){var s={}
return Object.keys(i).forEach((function(e){s[e]=i[e]})),s.enumerable=!!s.enumerable,s.configurable=!!s.configurable,("value"in s||s.initializer)&&(s.writable=!0),s=r.slice().reverse().reduce((function(r,i){return i(e,t,r)||r}),s),n&&void 0!==s.initializer&&(s.value=s.initializer?s.initializer.call(n):void 0,s.initializer=void 0),void 0===s.initializer&&(Object.defineProperty(e,t,s),s=null),s}const{changeProperties:X}=w.default,Z=s.dependentKeyCompat
function ee(e,t,r,i){let n=i||[],s=t.relationships
if(!s)return n
...
return o&&n.push.apply(n,o),e.superclass&&ee(e.superclass,t,r,n),n}function te(e,t,r){const i=new WeakMap
let n=r.get
return r.get=function(){let e=i.get(this)
return e||(e={hasComputed:!1,value:void 0},i.set(this,e)),e.hasComputed||(e.value=n.call(this),e.hasComputed=!0),e.value},r}let re=(Q=class extends _.default{constructor(){var e,t,r,i
...
return this.eachAttribute(((t,r)=>{r.type&&e.set(t,r.type)})),e}static eachAttribute(e,t){this.attributes.forEach(((r,i)=>{e.call(t,i,r)}))}static eachTransformedAttribute(e,t){this.transformedAttributes.forEach(((r,i)=>{e.call(t,i,r)}))}static toString(){return`model:${r.get(this,"modelName")}`}},Q.isModel=!0,Q.modelName=null,J((Y=Q).prototype,"isEmpty",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isEmpty"),Y.prototype),J(Y.prototype,"isLoading",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isLoading"),Y.prototype),J(Y.prototype,"isLoaded",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isLoaded"),Y.prototype),J(Y.prototype,"hasDirtyAttributes",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"hasDirtyAttributes"),Y.prototype),J(Y.prototype,"isSaving",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isSaving"),Y.prototype),J(Y.prototype,"isDeleted",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isDeleted"),Y.prototype),J(Y.prototype,"isNew",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isNew"),Y.prototype),J(Y.prototype,"isValid",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"isValid"),Y.prototype),J(Y.prototype,"dirtyType",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(Y.prototype,"dirtyType"),Y.prototype),J(Y.prototype,"isError",[Z],Object.getOwnPropertyDescriptor(Y.prototype,"isError"),Y.prototype),K=J(Y.prototype,"isReloading",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),J(Y.prototype,"id",[q],Object.getOwnPropertyDescriptor(Y.prototype,"id"),Y.prototype),J(Y.prototype,"currentState",[q],Object.getOwnPropertyDescriptor(Y.prototype,"currentState"),Y.prototype),J(Y.prototype,"errors",[te],Object.getOwnPropertyDescriptor(Y.prototype,"errors"),Y.prototype),J(Y.prototype,"adapterError",[Z],Object.getOwnPropertyDescriptor(Y.prototype,"adapterError"),Y.prototype),J(Y,"inverseMap",[te],Object.getOwnPropertyDescriptor(Y,"inverseMap"),Y),J(Y,"relationships",[te],Object.getOwnPropertyDescriptor(Y,"relationships"),Y),J(Y,"relationshipNames",[te],Object.getOwnPropertyDescriptor(Y,"relationshipNames"),Y),J(Y,"relatedTypes",[te],Object.getOwnPropertyDescriptor(Y,"relatedTypes"),Y),J(Y,"relationshipsByName",[te],Object.getOwnPropertyDescriptor(Y,"relationshipsByName"),Y),J(Y,"relationshipsObject",[te],Object.getOwnPropertyDescriptor(Y,"relationshipsObject"),Y),J(Y,"fields",[te],Object.getOwnPropertyDescriptor(Y,"fields"),Y),J(Y,"attributes",[te],Object.getOwnPropertyDescriptor(Y,"attributes"),Y),J(Y,"transformedAttributes",[te],Object.getOwnPropertyDescriptor(Y,"transformedAttributes"),Y),Y)
function ie(e,t){const r=e.length,i=t.length,n=Math.min(r,i)
let s=null
...
break}a=i-l-s,o=r-l-s}return{firstChangeIndex:s,addedCount:a,removedCount:o}}re.prototype._internalModel=null,re.prototype.store=null,re.prototype._createProps=null,re.prototype._debugInfo=function(){let e=["id"],t={},r=[]
this.eachAttribute(((t,r)=>e.push(t)))
let i=[{name:"Attributes",properties:e,expand:!0}]
return this.eachRelationship(((e,n)=>{let s=t[n.kind]
void 0===s&&(s=t[n.kind]=[],i.push({name:n.kind,properties:s,expand:!0})),s.push(e),r.push(e)})),i.push({name:"Flags",properties:["isLoaded","hasDirtyAttributes","isSaving","isDeleted","isError","isNew","isValid"]}),{propertyInfo:{includeOtherProperties:!0,groups:i,expensiveProperties:r}}},re.reopen(i.DeprecatedEvented,{trigger(e){{let t=this[e]
...
i._isDematerializing||i.currentState.isEmpty||!i.currentState.isLoaded||t.push(i)}if(e.meta&&(this._meta=e.meta),e.links&&(this._links=e.links),this._hasArrayObservers&&!this._hasNotified){let e=ie(this.currentState,t)
...
function he(e,t,r,i){r&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(i):void 0})}function pe(e,t,r,i,n){var s={}
return Object.keys(i).forEach((function(e){s[e]=i[e]})),s.enumerable=!!s.enumerable,s.configurable=!!s.configurable,("value"in s||s.initializer)&&(s.writable=!0),s=r.slice().reverse().reduce((function(r,i){return i(e,t,r)||r}),s),n&&void 0!==s.initializer&&(s.value=s.initializer?s.initializer.call(n):void 0,s.initializer=void 0),void 0===s.initializer&&(Object.defineProperty(e,t,s),s=null),s}let fe=(ae=class{constructor(e,t){he(this,"content",oe,this),he(this,"isPending",le,this),he(this,"isRejected",ue,this),he(this,"isFulfilled",ce,this),he(this,"isSettled",de,this),this._update(e,t),this.isDestroyed=!1,this.isDestroying=!1
...
return new this(t,r)}createRecord(){return this.content.createRecord(...arguments)}get firstObject(){return this.content?this.content.firstObject:void 0}get lastObject(){return this.content?this.content.lastObject:void 0}},oe=pe(ae.prototype,"content",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),pe(ae.prototype,"length",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(ae.prototype,"length"),ae.prototype),pe(ae.prototype,"[]",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(ae.prototype,"[]"),ae.prototype),le=pe(ae.prototype,"isPending",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),ue=pe(ae.prototype,"isRejected",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),ce=pe(ae.prototype,"isFulfilled",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),de=pe(ae.prototype,"isSettled",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),pe(ae.prototype,"links",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(ae.prototype,"links"),ae.prototype),pe(ae.prototype,"meta",[s.dependentKeyCompat],Object.getOwnPropertyDescriptor(ae.prototype,"meta"),ae.prototype),ae);["addObserver","cacheFor","decrementProperty","get","getProperties","incrementProperty","notifyPropertyChange","removeObserver","set","setProperties","toggleProperty"].forEach((e=>{fe.prototype[e]=function(){for(var t=arguments.length,r=new Array(t),i=0;i<t;i++)r[i]=arguments[i]
return w.default[e](this,...r)}}));["addArrayObserver","addObject","addObjects","any","arrayContentDidChange","arrayContentWillChange","clear","compact","every","filter","filterBy","find","findBy","getEach","includes","indexOf","insertAt","invoke","isAny","isEvery","lastIndexOf","map","mapBy","objectAt","objectsAt","popObject","pushObject","pushObjects","reduce","reject","rejectBy","removeArrayObserver","removeAt","removeObject","removeObjects","replace","reverseObjects","setEach","setObjects","shiftObject","slice","sortBy","toArray","uniq","uniqBy","unshiftObject","unshiftObjects","without"].forEach((e=>{fe.prototype[e]=function(){return this.content[e](...arguments)}})),["on","has","trigger","off","one"].forEach((e=>{fe.prototype[e]=function(){return this.content[e](...arguments)}})),e.Errors=D,e.ManyArray=ne,e.Model=re,e.PromiseBelongsTo=se,e.PromiseManyArray=fe,e._modelForMixin=function(e,t){let r=b.getOwner(e),i=r.factoryFor(`mixin:${t}`),n=i&&i.class
if(n){let e=re.extend(n)
e.reopenClass({__isMixin:!0,__mixin:n}),r.register("model:"+t,e)}return r.factoryFor(`model:${t}`)},e.attr=P,e.belongsTo=k,e.diffArray=ie,e.hasMany=x,Object.defineProperty(e,"__esModule",{value:!0})})),define("@ember-data/model/index",["exports","@ember-data/model/-private"],(function(e,t){"use strict"
